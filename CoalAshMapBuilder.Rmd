...
coal_ash_ponds <- coal_ash_ponds %>% st_jitter(factor = 0.0045)
```
...
state_ponds_popup_text <- paste0("In ", us_map_with_ponds$NAME, ", there are ", as.character(us_map_with_ponds$TOTAL_PONDS), " coal ash ponds.")
```
